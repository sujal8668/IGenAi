...
const BuyCredit = () => {
  ...
  const initPay = async (order) => {
    const options = {
      key: import.meta.env.VITE_RAZOPAY_KEY_ID,
      amount: order.amount,
      ...
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item, index) => (
          ...
          >
            ...
            <button onClick={() => paymentRazorpay(item.id)} className="w-full bg-gray-800 text-white text-sm mt-8 rounded-md py-2.5 min-w-52 cursor-pointer">
